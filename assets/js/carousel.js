export class Carousel {
  constructor(options = {}) {
    try {
      const {
        containerIdName = '#carousel', slidesClassName = '.slide__item', isAutoplayCarousel = true, AutoplayInterval = 10000, isControlButtonsEnabled = true, isControlPlayPauseEnabled = true, isIndicatorsEnabled = true, isPauseAfterAction = false, isAnimateButtonsHandler = true, isAnimateButtonAutoplayAndIndicators = false, isPauseWhenMouseFocus = false, iconPause = '<i class="fas fa-pause" id="pause-btn"></i>', iconPlay = '<i class="fas fa-play" id="play-btn"></i>', iconPrev = '<i class="fas fa-angle-left" id="prev-btn"></i>', iconNext = '<i class="fas fa-angle-right" id="next-btn"></i>', iconDownload = '<i class="fa-solid fa-spinner"></i>', userStyles = {},
      } = options;
